...
export const COOKIE_SKILLS: Record<SkillSlot, SkillDefinition> = {
  Q: {
    ...
    shortName: "Bomb",
    gestureId: "circle",
    gestureLabel: "손으로 원을 그려 젤리를 던져요!",
    cooldown: 6,
    gaugeCost: 24,
    color: 0xff7ad9,
    uiColor: "#ff7ad9",
